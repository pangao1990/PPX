...
os.system(f'mkdir -p {buildDir}/PPX/DEBIAN')
os.system(f'mkdir -p {buildDir}/PPX/opt/{appName}/bin')
os.system(f'mkdir -p {buildDir}/PPX/usr/share/applications')
os.system(f'mkdir -p {buildDir}/PPX/usr/share/icons/hicolor/128x128/apps')
os.system(f'cp {buildDir}/bin/{appName} {buildDir}/PPX/opt/{appName}/bin/{appName}')
os.system(f'cp {scriptDir}/control {buildDir}/PPX/DEBIAN/control')
os.system(f'cp {scriptDir}/postinst {buildDir}/PPX/DEBIAN/postinst && chmod 755 {buildDir}/PPX/DEBIAN/postinst')
os.system(f'cp {scriptDir}/{appName}.desktop {buildDir}/PPX/usr/share/applications/{appName}.desktop')
os.system(f'cp {logoPath} {buildDir}/PPX/usr/share/icons/hicolor/128x128/apps/{appName}.png')
